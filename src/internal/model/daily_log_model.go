...
type DailyLog struct {
	...
	FreshFeedCollectionId  *int            `json:"freshFeedCollectionId" gorm:"column:fresh_feed_collection_id"`
	PelletFeedCollectionId *int            `json:"pelletFeedCollectionId" gorm:"column:pellet_feed_collection_id"`
