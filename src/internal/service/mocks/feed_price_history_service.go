...
func (_m *MockFeedPriceHistoryService) Update(ctx context.Context, request dto.UpdateFeedPriceHistoryRequest, username string) error {
	ret := _m.Called(ctx, request, username)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, dto.UpdateFeedPriceHistoryRequest, string) error); ok {
		r0 = rf(ctx, request, username)
	} else {
		r0 = ret.Error(0)
	}
