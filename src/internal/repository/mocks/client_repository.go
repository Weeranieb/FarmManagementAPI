...
func (_m *MockClientRepository) Create(ctx context.Context, client *model.Client) error {
...
func (_m *MockClientRepository) Update(ctx context.Context, client *model.Client) error {
	ret := _m.Called(ctx, client)
